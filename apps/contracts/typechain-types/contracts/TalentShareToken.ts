...
export interface TalentShareTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface TalentShareToken extends BaseContract {
  connect(runner?: ContractRunner | null): TalentShareToken;
  waitForDeployment(): Promise<this>;

  interface: TalentShareTokenInterface;
