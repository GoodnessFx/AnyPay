...
export interface UpNextTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface UpNextToken extends BaseContract {
  connect(runner?: ContractRunner | null): UpNextToken;
  waitForDeployment(): Promise<this>;

  interface: UpNextTokenInterface;
